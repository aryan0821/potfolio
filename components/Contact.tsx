    ...
    return (
        <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <div className='flex flex-col space-y-8'>
                <h4 className='text-2xl font-normal text-center'>I have just what you need. <span className="underline decoration-[#a2d0fa]">Let's Talk</span></h4>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 w-fit mx-auto'>
                    ...
                    <button type="submit" className='bg-gradient-to-r from-[#044689] via-[#4c9ae2] to-[#a2d0fa] py-3 px-10 rounded-full text-black font-bold text-lg'>Submit</button>
                </form>
            </div>
        </div>
    )
